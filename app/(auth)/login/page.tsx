    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-orange-100 p-6">
      ...
      >
        ...
        <div className="flex-1 px-16 py-20 flex flex-col items-center justify-center">
          ...
          <h1 className="font-nunito text-3xl md:text-4xl font-extrabold text-gray-900 mb-5">
            Sign In
          </h1>
        ...
        {/* ── RIGHT: Orange panel ── */}
        <div className="w-6/12 relative overflow-hidden bg-gradient-to-br from-orange-500 to-orange-600 rounded-l-[160px] flex flex-col items-center justify-center p-14">
          <div className="absolute w-[180px] h-[180px] rounded-full bg-white/8 -top-12 -right-12" />
          <div className="absolute w-[120px] h-[120px] rounded-full bg-white/8 -bottom-2 -left-7" />
